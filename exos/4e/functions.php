...
function calculMental()
{
    for ($print = 1;$print <= 6;$print++)
    {
        ...
        {
            $a = $chiffre2 * (-$chiffre1);
            $b = $chiffre2 * ($chiffre1-1);
            $c = $chiffre2 * $chiffre1;
            $d = -$b;
        }
        else if ($chiffre1==0 or $chiffre2==0)
        {
            $a = $chiffre1 + $chiffre2;
            $c = $chiffre1 * $chiffre2;
            if ($chiffre1==0){$b = $chiffre1-$chiffre2; $d = $chiffre2*10;}
            else{$b = $chiffre2-$chiffre1; $d = $chiffre1*10;}
        }else
        {
